...
//    {
//        WriteLine($"How {row}, Column {col}: {grid1[row, col]}");
//    }
//};
#endregion

#region Jagged array
//string[][] jagged = // Array of string arrays.
...
#region Array / List pattern matching

// Define some arrays with int values, and then pass them to a method that returns descriptive 
// text depending on the pattern that matches 
...
int[] fibonacciNumbers = { 0, 1, 1, 2, 3, 5, 7, 8, 13, 23, 29 };
...
[int item1, int item2, int item3] =>
 $"Contains {item2} {item2} then {item3}.",
