...
// Implementing funtionality using methods.
...
// Call the static instance method to make a baby.
...
#region Defineing and handling delegates
...
#region Comparing objects using a seperate class
...
{
    Name = "John Jones",
    Born = new(year: 1900, month: 7, day: 28,
...
#region Understanding pylymorphism
...
#region Casting within inheriteance hierarchies
...
if (aliceInPerson is Employee)
{
    ...
    // Safely do something  with explictAlice;
}
#endregion
...
{
    WriteLine($"{nameof(aliceInPerson)} as Employee.");
...
try 
{
    ...
    john.TimeTravel(when: new(1000, 12, 25));
}
